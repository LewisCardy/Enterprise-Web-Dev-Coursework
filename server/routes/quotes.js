...
let totalPay = 0; //total pay
let totalHours = 0; //total hours
let itemPrice = 0; //price of items
...
let fudgeFactor = (Math.random() * (1.5 - 0.5) + 0.5).toFixed(1); //when the server starts set the fudge factor value
